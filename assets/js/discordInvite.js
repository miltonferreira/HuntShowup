var discordInvite = discordInvite || function() {
    ...
    return {
        init: function(e) {
            e.inviteCode = void 0 !== e.inviteCode && e.inviteCode, e.title = void 0 !== e.title ? e.title : "", e.introText = void 0 !== e.introText ? e.introText : "Você foi convidado(a) a entrar em um servidor", e.joinText = void 0 !== e.joinText ? e.joinText : "Entrar", e.joinedText = void 0 !== e.joinedText ? e.joinedText : "Entrou", e.width = void 0 !== e.width ? e.width : 'auto', e.miniMode = void 0 !== e.miniMode && e.miniMode, e.hideIntro = void 0 !== e.hideIntro && e.hideIntro, e.targetElement = void 0 !== e.targetElement ? e.targetElement : "#discordInviteBox", i.inviteCode = e.inviteCode, i.title = e.title, i.introText = e.introText, i.joinText = e.joinText, i.joinedText = e.joinedText, i.miniMode = e.miniMode, i.hideIntro = e.hideIntro, i.width = e.width, i.targetElement = e.targetElement
        },
        render: function() {
            if (window.jQuery) d();
            else {
...
// fonte - https://github.com/Aegis7Gaming/Discord-Invite-JS-HTML-CSS